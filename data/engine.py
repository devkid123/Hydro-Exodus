...
class entity(object):
    ...
    def new_rect(self,scroll):
        return pygame.Rect(self.x-scroll[0],self.y-scroll[1],self.size_x,self.size_y)
    ...
    def transform_image(self,width,height):
        img = self.get_drawn_img()[0]
        real_img = pygame.transform.scale(img,(width,height))
        self.set_image(real_img)
